...
public class ObjectSerializerDse7<T> implements ObjectSerializer<T> {
   ...
   */
  public ObjectSerializerDse7(Class<T> clazz, Type genericType) {
    serializers =
        GenericSerializerDse7.simpleType(genericType)
            ? ImmutableSortedMap.<String, FieldSerializer>of(
                "result", new FieldSerializer(GenericSerializerDse7.getType(genericType), x -> x))
  ...
  public ObjectSerializerDse7(Class<T> clazz) {
    this(clazz, clazz);
  }
