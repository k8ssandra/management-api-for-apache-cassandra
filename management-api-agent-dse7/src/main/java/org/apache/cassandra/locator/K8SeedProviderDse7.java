...
public class K8SeedProviderDse7 implements SeedProvider {
  private static final Logger logger = LoggerFactory.getLogger(K8SeedProviderDse7.class);

  public K8SeedProviderDse7() {}
