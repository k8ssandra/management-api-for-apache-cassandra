...
import com.datastax.mgmtapi.resources.models.v2.EndpointStatesResponse;
...
public class MetadataResourcesV2 extends BaseResource {
  ...
  public Response getEndpointStates() {
    ...
    return Response.serverError().entity("Shit broke").build();
  }
}
