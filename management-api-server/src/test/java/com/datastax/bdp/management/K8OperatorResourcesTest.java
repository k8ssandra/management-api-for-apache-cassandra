...
import com.datastax.bdp.management.resources.models.CompactRequest;
import com.datastax.bdp.management.resources.models.KeyspaceRequest;
import com.datastax.bdp.management.resources.models.ScrubRequest;
...
public class K8OperatorResourcesTest {
    ...
    private static Context setup() {
        ...
        ManagementApplication app = new ManagementApplication(null, null, context.cqlService,null);
