...
import com.datastax.bdp.management.helpers.NettyHttpClient;
...
public class NettyTlsClientAuthTest
{
    ...
    {
        File serverKeyFile = getFile(getClass(), "mutual_auth_ca.key");
        File serverCrtFile = getFile(getClass(), "mutual_auth_ca.pem");
    ...
    {
        File trustCertFile = getFile(getClass(), "mutual_auth_ca.pem");
        File serverKeyFile = getFile(getClass(), "mutual_auth_server.key");
        File serverCrtFile = getFile(getClass(), "mutual_auth_server.crt");
        String serverKeyPassword = null;
    ...
    {
        File trustCertFile = getFile(getClass(), "mutual_auth_client_cert_chain.pem");
        File serverKeyFile = getFile(getClass(), "mutual_auth_server.key");
        File serverCrtFile = getFile(getClass(), "mutual_auth_server.crt");
        String serverKeyPassword = null;

        File trustFileIntermediate = getFile(getClass(), "mutual_auth_client_cert_chain.pem");
        File clientKeyFile = getFile(getClass(), "mutual_auth_client.key");
    ...
    public void testTrustedChainUntrustedClientCert() throws Throwable
    {
        ...
        File trustFileIntermediate = getFile(getClass(), "mutual_auth_invalid_client_cert_chain.pem");
        File clientKeyFile = getFile(getClass(), "mutual_auth_invalid_client.key");
        File clientCrtFile = getFile(getClass(), "mutual_auth_invalid_client.crt");
        String clientKeyPassword = null;
