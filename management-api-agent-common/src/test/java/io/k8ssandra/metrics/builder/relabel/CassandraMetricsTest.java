...
public class CassandraMetricsTest {
    ...
    public void smokeTest() {
        ...
        // Table
        CassandraMetricDefinition tableMetric = parser.parseDropwizardMetric("org.apache.cassandra.metrics.Table.MetricName.KeyspaceName.TableName", "", Lists.newArrayList(), Lists.newArrayList());
        ...
        // Keyspace
        CassandraMetricDefinition keyspaceMetric = parser.parseDropwizardMetric("org.apache.cassandra.metrics.keyspace.MetricName.KeyspaceName", "", Lists.newArrayList(), Lists.newArrayList());
        assertEquals("org_apache_cassandra_metrics_keyspace_metric_name", keyspaceMetric.getMetricName());
        ...
        // ThreadPool Metrics
        CassandraMetricDefinition threadPoolMetric = parser.parseDropwizardMetric("org.apache.cassandra.metrics.ThreadPools.MetricName.Path.ThreadPoolName", "", Lists.newArrayList(), Lists.newArrayList());
        assertEquals("org_apache_cassandra_metrics_thread_pools_metric_name", threadPoolMetric.getMetricName());
        ...
        CassandraMetricDefinition clientRequestMetric = parser.parseDropwizardMetric("org.apache.cassandra.metrics.ClientRequest.MetricName.RequestType", "", Lists.newArrayList(), Lists.newArrayList());
        assertEquals("org_apache_cassandra_metrics_client_request_metric_name", clientRequestMetric.getMetricName());
        ...
        // Cache Metrics
        CassandraMetricDefinition cacheMetric = parser.parseDropwizardMetric("org.apache.cassandra.metrics.Cache.MetricName.CacheName", "", Lists.newArrayList(), Lists.newArrayList());
        ...
        CassandraMetricDefinition droppedMetric = parser.parseDropwizardMetric("org.apache.cassandra.metrics.DroppedMessage.MetricName.Type", "", Lists.newArrayList(), Lists.newArrayList());
        assertEquals("org_apache_cassandra_metrics_dropped_message_metric_name", droppedMetric.getMetricName());
        ...
        // Streaming metrics
        CassandraMetricDefinition streamingMetric = parser.parseDropwizardMetric("org.apache.cassandra.metrics.Streaming.MetricName.127.0.0.1", "", Lists.newArrayList(), Lists.newArrayList());
        assertEquals("org_apache_cassandra_metrics_streaming_metric_name", streamingMetric.getMetricName());
