...
public class MultiFilterTest {
    ...
    public void DropMultipleMetrics() {
        ...
        CassandraMetricDefinition jvmDefinition = new CassandraMetricDefinition("jvm_classes_loaded_total", Lists.newArrayList(), Lists.newArrayList());

        List<CassandraMetricDefinition> definitions = Lists.newArrayList(tableDefinition, keyspaceDefinition, jvmDefinition);
    ...
    public void KeepAndDropSubset() {
        ...
        CassandraMetricDefinition tableDefinitionProd = new CassandraMetricDefinition("org_apache_cassandra_metrics_table_range_latency_count",
                Lists.newArrayList("host", "cluster", "datacenter", "rack", "keyspace", "table"),
                Lists.newArrayList("6cc2e5ce-e73f-4592-8d02-fd5e17a070e3", "production", "dc1", "rack1", "system", "system_schema"));
        ...
        CassandraMetricDefinition keyspaceDefinitionProd = new CassandraMetricDefinition("org_apache_cassandra_metrics_keyspace_range_latency_count",
                Lists.newArrayList("host", "cluster", "datacenter", "rack", "keyspace"),
                Lists.newArrayList("6cc2e5ce-e73f-4592-8d02-fd5e17a070e3", "production", "dc1", "rack1", "system"));
        ...
        List<CassandraMetricDefinition> definitions = Lists.newArrayList(tableDefinitionTest, tableDefinitionProd, keyspaceDefinitionProd, keyspaceDefinitionTest);
        List<CassandraMetricDefinition> passed = new ArrayList<>(1);
